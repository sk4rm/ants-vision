...
@overload
def as_series(
    alist: npt.NDArray[np.integer[Any]] | _FloatArray, trim: bool = ...
) -> list[_FloatSeries]: ...
@overload
...
@overload
def as_series(
    alist: Iterable[_FloatArray | npt.NDArray[np.integer[Any]]], trim: bool = ...
) -> list[_FloatSeries]: ...
@overload
def as_series(
    alist: Iterable[_ComplexArray], trim: bool = ...
) -> list[_ComplexSeries]: ...
@overload
def as_series(
    alist: Iterable[_ObjectArray], trim: bool = ...
) -> list[_ObjectSeries]: ...
@overload
def as_series(
    alist: Iterable[_SeriesLikeFloat_co | float], trim: bool = ...
) -> list[_FloatSeries]: ...
@overload
def as_series(
    alist: Iterable[_SeriesLikeComplex_co | complex], trim: bool = ...
) -> list[_ComplexSeries]: ...
@overload
def as_series(
    alist: Iterable[_SeriesLikeCoef_co | object], trim: bool = ...
) -> list[_ObjectSeries]: ...
...
@overload
def trimcoef(
    c: npt.NDArray[np.integer[Any]] | _FloatArray, tol: _FloatLike_co = ...
) -> _FloatSeries: ...
@overload
...
@overload
def trimcoef(
    c: _SeriesLikeFloat_co | float, tol: _FloatLike_co = ...
) -> _FloatSeries: ...
@overload
def trimcoef(
    c: _SeriesLikeComplex_co | complex, tol: _FloatLike_co = ...
) -> _ComplexSeries: ...
@overload
def trimcoef(
    c: _SeriesLikeCoef_co | object, tol: _FloatLike_co = ...
) -> _ObjectSeries: ...
@overload
def getdomain(x: _FloatArray | npt.NDArray[np.integer[Any]]) -> _Array2[np.float64]: ...
@overload
...
@overload
def mapparms(
    old: npt.NDArray[np.number[Any]], new: npt.NDArray[np.number[Any]]
