...
class PPDocTranslation(PaddleXPipelineWrapper):
    ...
    def translate_iter(self, ori_md_info_list, *, target_language=..., chunk_size=..., task_description=..., output_format=..., rules_str=..., few_shot_demo_text_content=..., few_shot_demo_key_value_list=..., glossary=..., llm_request_interval=..., chat_bot_config=..., **kwargs):
        ...
    
    def translate(self, ori_md_info_list, *, target_language=..., chunk_size=..., task_description=..., output_format=..., rules_str=..., few_shot_demo_text_content=..., few_shot_demo_key_value_list=..., glossary=..., llm_request_interval=..., chat_bot_config=..., **kwargs): # -> list[Any]:
        ...
    ...
    @classmethod
    def get_cli_subcommand_executor(cls): # -> PPDocTranslationCLISubcommandExecutor:
        ...
...
class PPDocTranslationCLISubcommandExecutor(PipelineCLISubcommandExecutor):
    @property
    def subparser_name(self): # -> Literal['pp_doctranslation']:
        ...
